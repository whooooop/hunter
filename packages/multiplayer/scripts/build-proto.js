...
const command = `npx protoc --plugin="${pluginPath}" --ts_proto_out="./src" --ts_proto_opt="esModuleInterop=true,forceLong=string,outputServices=false" --proto_path="./src" ./src/sync.proto`;
